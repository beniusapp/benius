...
export async function registerRoutes(
  ...
  app.post("/api/admin/calendar/seed-holidays", async (req, res) => {
    ...
    // Variable holidays 2026–2031 (moon-based Islamic dates are approximate)
    const VARIABLE_HOLIDAYS: Record<number, { month: number; day: number; title: string }[]> = {
      2026: [
        ...
        { month: 3,  day: 29, title: "Ram Navami" },
        { month: 3,  day: 31, title: "Eid ul-Fitr (Ramzan Eid)" },
        { month: 4,  day: 3,  title: "Good Friday" },
        { month: 4,  day: 17, title: "Mahavir Jayanti" },
        { month: 6,  day: 7,  title: "Eid ul-Adha (Bakri Eid)" },
        { month: 6,  day: 25, title: "Muharram" },
        { month: 8,  day: 24, title: "Janmashtami" },
        { month: 8,  day: 25, title: "Milad-un-Nabi" },
        { month: 10, day: 1,  title: "Dussehra (Vijaya Dashami)" },
        { month: 10, day: 20, title: "Diwali (Lakshmi Puja)" },
        { month: 11, day: 5,  title: "Guru Nanak Jayanti" },
      ],
      2027: [
        { month: 2,  day: 15, title: "Maha Shivaratri" },
        { month: 3,  day: 19, title: "Ram Navami" },
        { month: 3,  day: 20, title: "Eid ul-Fitr (Ramzan Eid)" },
        { month: 3,  day: 22, title: "Holi" },
        { month: 3,  day: 26, title: "Good Friday" },
        { month: 4,  day: 6,  title: "Mahavir Jayanti" },
        { month: 5,  day: 27, title: "Eid ul-Adha (Bakri Eid)" },
        { month: 6,  day: 15, title: "Muharram" },
        { month: 8,  day: 11, title: "Janmashtami" },
        { month: 8,  day: 15, title: "Milad-un-Nabi" },
        { month: 9,  day: 20, title: "Dussehra (Vijaya Dashami)" },
        { month: 10, day: 8,  title: "Diwali (Lakshmi Puja)" },
        { month: 11, day: 25, title: "Guru Nanak Jayanti" },
      ],
      2028: [
        { month: 3,  day: 7,  title: "Maha Shivaratri" },
        { month: 3,  day: 11, title: "Holi" },
        { month: 4,  day: 7,  title: "Ram Navami" },
        { month: 4,  day: 7,  title: "Eid ul-Fitr (Ramzan Eid)" },
        { month: 4,  day: 14, title: "Good Friday" },
        { month: 4,  day: 26, title: "Mahavir Jayanti" },
        { month: 6,  day: 15, title: "Eid ul-Adha (Bakri Eid)" },
        { month: 7,  day: 5,  title: "Muharram" },
        { month: 8,  day: 4,  title: "Milad-un-Nabi" },
        { month: 8,  day: 29, title: "Janmashtami" },
        { month: 10, day: 17, title: "Diwali (Lakshmi Puja)" },
        { month: 10, day: 18, title: "Dussehra (Vijaya Dashami)" },
        { month: 11, day: 13, title: "Guru Nanak Jayanti" },
      ],
      2029: [
        { month: 2,  day: 24, title: "Maha Shivaratri" },
        { month: 3,  day: 1,  title: "Holi" },
        { month: 3,  day: 27, title: "Eid ul-Fitr (Ramzan Eid)" },
        { month: 3,  day: 29, title: "Good Friday" },
        { month: 4,  day: 7,  title: "Ram Navami" },
        { month: 4,  day: 15, title: "Mahavir Jayanti" },
        { month: 6,  day: 4,  title: "Eid ul-Adha (Bakri Eid)" },
        { month: 6,  day: 24, title: "Muharram" },
        { month: 7,  day: 24, title: "Milad-un-Nabi" },
        { month: 8,  day: 19, title: "Janmashtami" },
        { month: 10, day: 7,  title: "Dussehra (Vijaya Dashami)" },
        { month: 10, day: 19, title: "Diwali (Lakshmi Puja)" },
        { month: 11, day: 8,  title: "Guru Nanak Jayanti" },
      ],
      2030: [
        { month: 2,  day: 13, title: "Maha Shivaratri" },
        { month: 3,  day: 16, title: "Eid ul-Fitr (Ramzan Eid)" },
        { month: 3,  day: 20, title: "Holi" },
        { month: 3,  day: 28, title: "Ram Navami" },
        { month: 4,  day: 5,  title: "Mahavir Jayanti" },
        { month: 4,  day: 19, title: "Good Friday" },
        { month: 5,  day: 24, title: "Eid ul-Adha (Bakri Eid)" },
        { month: 6,  day: 13, title: "Muharram" },
        { month: 7,  day: 14, title: "Milad-un-Nabi" },
        { month: 8,  day: 8,  title: "Janmashtami" },
        { month: 9,  day: 27, title: "Dussehra (Vijaya Dashami)" },
        { month: 10, day: 9,  title: "Diwali (Lakshmi Puja)" },
        { month: 11, day: 2,  title: "Guru Nanak Jayanti" },
      ],
      2031: [
        { month: 3,  day: 5,  title: "Maha Shivaratri" },
        { month: 3,  day: 10, title: "Holi" },
        { month: 4,  day: 4,  title: "Eid ul-Fitr (Ramzan Eid)" },
        { month: 4,  day: 11, title: "Good Friday" },
        { month: 4,  day: 16, title: "Ram Navami" },
        { month: 4,  day: 25, title: "Mahavir Jayanti" },
        { month: 6,  day: 12, title: "Eid ul-Adha (Bakri Eid)" },
        { month: 7,  day: 2,  title: "Muharram" },
        { month: 7,  day: 15, title: "Milad-un-Nabi" },
        { month: 8,  day: 27, title: "Janmashtami" },
        { month: 10, day: 5,  title: "Dussehra (Vijaya Dashami)" },
        { month: 10, day: 25, title: "Diwali (Lakshmi Puja)" },
  ...
  app.get("/api/admin/calendar/google-settings", async (req, res) => {
    if (!req.session.userId || req.session.userRole !== "admin") return res.status(403).json({ message: "Admin access required" });
    const schoolId = req.session.schoolId!;
    const config = await storage.getSchoolMetadataRaw(schoolId, "google_calendar_config") as any;
    const lastSync = await storage.getSchoolMetadataRaw(schoolId, "google_calendar_last_sync") as any;
    const autoSync = await storage.getSchoolMetadataRaw(schoolId, "google_calendar_auto_sync") as boolean | null;
    res.json({
  ...
  app.post("/api/admin/calendar/google-settings", async (req, res) => {
    if (!req.session.userId || req.session.userRole !== "admin") return res.status(403).json({ message: "Admin access required" });
    const schoolId = req.session.schoolId!;
    const { calendarId, apiKey, autoSync } = req.body;
    if (!calendarId || !apiKey) return res.status(400).json({ message: "calendarId and apiKey are required" });
    await storage.setSchoolMetadataRaw(schoolId, "google_calendar_config", { calendarId, apiKey });
    if (typeof autoSync === "boolean") {
      await storage.setSchoolMetadataRaw(schoolId, "google_calendar_auto_sync", autoSync);
    }
    res.json({ message: "Google Calendar settings saved" });
  });

  app.patch("/api/admin/calendar/google-auto-sync", async (req, res) => {
    if (!req.session.userId || req.session.userRole !== "admin") return res.status(403).json({ message: "Admin access required" });
    const schoolId = req.session.schoolId!;
    const { autoSync } = req.body;
    if (typeof autoSync !== "boolean") return res.status(400).json({ message: "autoSync must be a boolean" });
    await storage.setSchoolMetadataRaw(schoolId, "google_calendar_auto_sync", autoSync);
    res.json({ message: `Auto-sync ${autoSync ? "enabled" : "disabled"}` });
  });

  app.post("/api/admin/calendar/sync-google", async (req, res) => {
    if (!req.session.userId || req.session.userRole !== "admin") return res.status(403).json({ message: "Admin access required" });
    const schoolId = req.session.schoolId!;
    const config = await storage.getSchoolMetadataRaw(schoolId, "google_calendar_config") as any;
    if (!config?.calendarId || !config?.apiKey) {
      return res.status(400).json({ message: "Google Calendar is not configured. Please save your Calendar ID and API Key first." });
    }
    const { syncGoogleCalendarForSchool } = await import("./google-calendar-sync");
    const result = await syncGoogleCalendarForSchool(schoolId, config.calendarId, config.apiKey);
    if (result.error) return res.status(400).json({ message: result.error });
    res.json({ message: `Synced ${result.count} events from Google Calendar`, count: result.count });
  });
