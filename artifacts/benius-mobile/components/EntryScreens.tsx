...
const styles = StyleSheet.create({
  ...
  landingWordmark: { fontFamily: 'OpenSans_400Regular', fontWeight: '900', fontSize: 18, letterSpacing: -0.4 },
  ...
  heroTitle: { fontFamily: 'OpenSans_400Regular', fontWeight: '900', letterSpacing: -0.7, textAlign: 'center' },
  ...
  portalTitle: { fontFamily: 'OpenSans_400Regular', fontWeight: '700', lineHeight: 21 },
  ...
  loginWordmark: { fontFamily: 'OpenSans_400Regular', fontWeight: '700', fontSize: 19, letterSpacing: -0.3 },
  ...
  teacherLoginTitle: { fontFamily: 'OpenSans_400Regular', fontSize: 25, fontWeight: '700', textAlign: 'center' },
  loginTitle: { fontFamily: 'OpenSans_400Regular', fontSize: 21, fontWeight: '700', textAlign: 'center' },
  ...
  primaryButtonText: { fontFamily: 'OpenSans_400Regular', fontSize: 16, fontWeight: '600' },
