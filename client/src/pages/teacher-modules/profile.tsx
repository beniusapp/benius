...
import {
  ...
  Camera, Loader2, Lock, Eye, EyeOff, CheckCircle, X, ZoomIn, ZoomOut,
} from "lucide-react";
  ...
  return (
    <>
      ...
      >
        ...
        <motion.div
          variants={fadeUp}
          className="relative rounded-2xl overflow-hidden border border-white/10 bg-gradient-to-br from-[#0f1e34]/90 to-[#0a1628]/90 backdrop-blur-sm shadow-xl"
        >
          ...
          <div className="relative px-6 pt-7 pb-6 flex flex-col items-center gap-1 text-center">
            ...
            <button
              onClick={() => fileInputRef.current?.click()}
              className="mt-1 flex items-center gap-1.5 text-xs text-[#10b981] hover:text-emerald-400 font-medium transition-colors py-1 px-3 rounded-full border border-[#10b981]/30 hover:border-[#10b981]/60 hover:bg-[#10b981]/8"
          ...
          <div className="px-5 pb-6 space-y-2">
            {fields.map((f) => {
              ...
              return (
                <div
                  key={f.label}
                  className="flex items-center gap-3 px-4 py-3 rounded-xl bg-white/5 border border-white/8 hover:border-white/15 transition-colors"
        ...
        <motion.div
          variants={fadeUp}
          className="rounded-2xl border border-white/10 bg-gradient-to-br from-[#0f1e34]/90 to-[#0a1628]/90 backdrop-blur-sm shadow-xl overflow-hidden"
            ...
            <form onSubmit={handlePasswordSubmit} className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <Input
                    ...
                    className="rounded-xl pr-10 bg-white/6 border-white/12 text-white placeholder:text-white/25 focus:border-[#10b981]/50 focus:ring-[#10b981]/20"
              ...
              <div className="space-y-1.5">
                ...
                {confirmPassword && confirmPassword === newPassword && newPassword.length >= 6 && (
                  <p className="text-xs text-[#10b981]">✓ Passwords match</p>
                )}
              </div>
              ...
              <Button
                ...
                className="w-full h-11 rounded-xl bg-[#10b981] hover:bg-emerald-600 text-white font-semibold shadow-lg shadow-emerald-900/30 transition-all"
