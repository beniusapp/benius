 ...
 * invoice-snapshot.ts
 *
 * Pure utility for building the immutable breakdown snapshot at invoice-creation time.
 *
 * buildBreakdownSnapshot — validates and deep-copies fee_structures.breakdown
 *   into fee_records.breakdown_snapshot.
 *
 * The snapshot is written exactly once when an invoice is created and must
